...
class Testing:                                                                                                          # public class Testing {
    ...
    def runTestOne(self):
        ...
        candidates = []
        flights.append(Flight.Flight("modern", "pass", self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("major", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("general", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("steve", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("quin", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("dario", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("mario", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("lario", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("bario", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("snarf", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        flights.append(Flight.Flight("snarfsnarf", "pass",self.RandFloat(1, 100), self.RandFloat(0, 1), 4.0, self.RandFloat(0, 1),self.RandFloat(0, 1), self.RandFloat(0, 1),self.RandFloat(0, 1)))
        ...
        fp1 = FlightPlanCoordinator.FlightPlanCoordinator().ordSplit(ParameterCore.ParameterCore().BRUTE_BOUND - 1, candidates)           # FlightPlan fp1 = FlightPlanCoordinator.ordSplit(ParameterCore.BRUTE_BOUND-1, candidates);
